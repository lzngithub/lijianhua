...
import { Card, Row, Col, Switch, Space, Tag, Radio, Progress, Table } from 'antd'
import {
    FlagOutlined,
    SmileOutlined,
    PoundOutlined,
            ...
            <div className='page-home'>
                ...
                <div className="home-chart mt-20">
                    <Card title="访问量" extra={
                        ...
                        <Row gutter={16}>
                            ...
                            <Col span={8}>
                                <div className="p15">
                                    <p className={`pb-10 fs-20 text-grey-6 chart-title`}>月访问数</p>
                                    <p>同上期增长</p>
                                    <Progress percent={chartData.monthVisit} strokeWidth={12}  />
                                </div>
                                <div className="p15">
                                    <p className={`pb-10 fs-20 text-grey-6 chart-title`}>月下载数</p>
                                    <p>同上期增长</p>
                                    <Progress percent={chartData.monthDownload} strokeWidth={12}  />
                                </div>
                                <div className="p15">
                                    <p className={`pb-10 fs-20 text-grey-6 chart-title`}>月收入</p>
                                    <p>同上期增长</p>
                ...
                <div className="home-table mt-20">
                    <Row gutter={16}>
                        <Col span={12}>
                            <Card title="本周活跃用户列表">
                                <Table columns={UserColumns} className="table-border" dataSource={userTableData} pagination={false}></Table>
                            </Card>
                        </Col>
                        <Col span={12}>
                            <Card title="项目进展">
                                <Table columns={TaskColumns} className="table-border" dataSource={taskTableData} pagination={false}></Table>
                            </Card>
                        </Col>
                    </Row>
                </div>
